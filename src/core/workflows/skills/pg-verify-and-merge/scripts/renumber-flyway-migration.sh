...
#   问题：脚本位于 .pg/skills/src/core/workflows/skills/pg-verify-and-merge/scripts/,
#         dirname = scripts, .. = .pg/skills/src/core/workflows/skills/pg-verify-and-merge,
...
#   因为编排器总是在项目根运行脚本（如 cd /home/.../webvirt && bash .pg/skills/src/core/workflows/...），
#   PWD 必然是项目根或子目录。
