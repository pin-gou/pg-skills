...
class Orchestrator:
        ...
        if expected_result_path and not os.path.isfile(expected_result_path):
            ...
            return {
                ...
                "hint": (
                    ...
                    "修复方法：sub-agent 必须调用:\n"
                    f"  python3 .pg/skills/src/core/workflows/skills/pg-build/scripts/pg-build-result "
    ...
    def _auto_archive(self) -> dict[str, Any]:
        ...
        script = os.path.join(
            bootstrap.PROJECT_ROOT, ".pg", "skills", "src", "core", "workflows", "skills", "pg-archive", "scripts", "pg-archive.py"
        )
        r = subprocess.run(
